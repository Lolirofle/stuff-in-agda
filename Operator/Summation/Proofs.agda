...
module _ {I : Type{ℓᵢ}} ⦃ equiv : Equiv{ℓₑ}(T) ⦄ ⦃ monoid : Monoid{T = T}(_▫_) ⦄ where
  ...
  ∑-postpend {x = x} {r = r₀ ⊰ r} {f = f} =
    f(r₀) ▫ ∑(postpend x r) f  🝖[ _≡_ ]-[ congruence₂-₂(_▫_)(f(r₀)) (∑-postpend {x = x}{r = r}{f = f}) ]
  ...
  ∑-concat {prepend x r₁} {r₂} {f} =
    f(x) ▫ ∑(r₁ ++ r₂) f      🝖[ _≡_ ]-[ congruence₂-₂(_▫_)(f(x)) (∑-concat {r₁}{r₂}{f}) ]
...
module _ ⦃ equiv : Equiv{ℓₑ}(T) ⦄ where
  ...
  module _ ⦃ monoid : Monoid(_+_) ⦄ ⦃ comm : Commutativity(_+_) ⦄ where
    ...
    ∑-add {r₀ ⊰ r} {f} {g} =
      ...
      (f(r₀) + g(r₀)) + (∑(r) f + ∑(r) g)      🝖[ _≡_ ]-[ congruence₂-₂(_+_)(f(r₀) + g(r₀)) (∑-add {r} {f} {g}) ]
  ...
  module _ ⦃ monoid : Monoid(_+_) ⦄ ⦃ distₗ : Distributivityₗ(_⋅_)(_+_) ⦄ ⦃ absorᵣ : Absorberᵣ(_⋅_)(Monoid.id monoid) ⦄ where
    ...
    ∑-scalar-multₗ {prepend r₀ r} {c} {f} =
      (c ⋅ f(r₀)) + ∑(r) (x ↦ c ⋅ f(x)) 🝖[ _≡_ ]-[ congruence₂-₂(_+_)(c ⋅ f(r₀)) (∑-scalar-multₗ {r}{c}{f}) ]
  ...
  module _ ⦃ monoid : Monoid(_+_) ⦄ ⦃ distᵣ : Distributivityᵣ(_⋅_)(_+_) ⦄ ⦃ absorₗ : Absorberₗ(_⋅_)(Monoid.id monoid) ⦄ where
    ...
    ∑-scalar-multᵣ {prepend r₀ r} {f} {c} =
      (f(r₀) ⋅ c) + ∑(r) (x ↦ f(x) ⋅ c) 🝖[ _≡_ ]-[ congruence₂-₂(_+_)(f(r₀) ⋅ c) (∑-scalar-multᵣ {r}{f}{c}) ]
...
∑-const {prepend x r}{c} = congruence₂-₂(_+_)(c) (∑-const {r}{c})
...
∑-mult {prepend x₁ r₁} {empty} {f} {g} =
  ...
  ∑(prepend x₁ r₁) (x ↦ 𝟎)                          🝖[ _≡_ ]-[ congruence₂-₂(∑)(prepend x₁ r₁) (Fn.intro(\{x} → ∑-empty {f = y ↦ f(x) ⋅ g(y)})) ]-sym
...
∑-mult {prepend x₁ r₁} {prepend x₂ r₂} {f} {g} =
  ...
  ((f(x₁) ⋅ g(x₂)) + (f(x₁) ⋅ (∑(r₂) g))) + (((∑(r₁) f) ⋅ g(x₂)) + ((∑(r₁) f) ⋅ (∑(r₂) g)))                 🝖[ _≡_ ]-[ congruence₂-₂(_+_) ((f(x₁) ⋅ g(x₂)) + (f(x₁) ⋅ (∑(r₂) g))) p ]
  ((f(x₁) ⋅ g(x₂)) + (f(x₁) ⋅ (∑(r₂) g))) + (∑(r₁) (x ↦ (f(x) ⋅ g(x₂)) + (∑(r₂) (y ↦ f(x) ⋅ g(y)))))        🝖[ _≡_ ]-[ congruence₂-₁(_+_) (∑(r₁) (x ↦ (f(x) ⋅ g(x₂)) + (∑(r₂) (y ↦ f(x) ⋅ g(y))))) (congruence₂-₂(_+_)(f(x₁) ⋅ g(x₂)) (∑-scalar-multₗ {r = r₂}{c = f(x₁)}{f = g})) ]-sym
  ...
  where
    p =      
      ...
      ∑(r₁) (x ↦ f(x) ⋅ (g(x₂) + (∑(r₂) g)))                        🝖[ _≡_ ]-[ congruence₂-₂(∑) r₁ (Fn.intro(\{x} → distributivityₗ(_⋅_)(_+_) {x = f(x)}{y = g(x₂)}{z = ∑(r₂) g})) ]
      ∑(r₁) (x ↦ (f(x) ⋅ g(x₂)) + (f(x) ⋅ (∑(r₂) g)))               🝖[ _≡_ ]-[ congruence₂-₂(∑) r₁ (Fn.intro(\{x} → congruence₂-₂(_+_) (f(x) ⋅ g(x₂)) (∑-scalar-multₗ {r = r₂}{c = f(x)}{f = g}))) ]-sym
...
∑-swap-nested {f} {prepend x₁ r₁} {prepend x₂ r₂} =
  ...
  f(x₁)(x₂) + (∑(r₂) (b ↦ f(x₁)(b)) + (∑(r₁) (a ↦ f(a)(x₂) + ∑(r₂) (b ↦ f(a)(b)))))               🝖[ _≡_ ]-[]
  f(x₁)(x₂) + (∑(r₂) (b ↦ f(x₁)(b)) + (∑(r₁) (a ↦ ∑(x₂ ⊰ r₂) (b ↦ f(a)(b)))))                     🝖[ _≡_ ]-[ congruence₂-₂(_+_)(f(x₁)(x₂)) (congruence₂-₂(_+_)(∑(r₂) (b ↦ f(x₁)(b))) (∑-swap-nested {f}{r₁}{x₂ ⊰ r₂})) ]
  f(x₁)(x₂) + (∑(r₂) (b ↦ f(x₁)(b)) + (∑(x₂ ⊰ r₂) (b ↦ ∑(r₁) (a ↦ f(a)(b)))))                     🝖[ _≡_ ]-[]
  f(x₁)(x₂) + (∑(r₂) (b ↦ f(x₁)(b)) + (∑(r₁) (a ↦ f(a)(x₂)) + (∑(r₂) (b ↦ ∑(r₁) (a ↦ f(a)(b)))))) 🝖[ _≡_ ]-[ congruence₂-₂(_+_)(f(x₁)(x₂)) (symmetry(_≡_) (associativity(_+_) {x = ∑(r₂) (b ↦ f(x₁)(b))}{y = ∑(r₁) (a ↦ f(a)(x₂))})) ]
  f(x₁)(x₂) + ((∑(r₂) (b ↦ f(x₁)(b)) + ∑(r₁) (a ↦ f(a)(x₂))) + (∑(r₂) (b ↦ ∑(r₁) (a ↦ f(a)(b))))) 🝖[ _≡_ ]-[ congruence₂-₂(_+_)(f(x₁)(x₂)) (congruence₂(_+_) (commutativity(_+_) {∑(r₂) (b ↦ f(x₁)(b))}{∑(r₁) (a ↦ f(a)(x₂))}) (symmetry(_≡_) (∑-swap-nested {f}{r₁}{r₂}))) ]
  f(x₁)(x₂) + ((∑(r₁) (a ↦ f(a)(x₂)) + ∑(r₂) (b ↦ f(x₁)(b))) + ∑(r₁) (a ↦ ∑(r₂) (b ↦ f(a)(b))))   🝖[ _≡_ ]-[ congruence₂-₂(_+_)(f(x₁)(x₂)) (associativity(_+_) {x = ∑(r₁) (a ↦ f(a)(x₂))}{y = ∑(r₂) (b ↦ f(x₁)(b))}) ]
  f(x₁)(x₂) + (∑(r₁) (a ↦ f(a)(x₂)) + (∑(r₂) (b ↦ f(x₁)(b)) + ∑(r₁) (a ↦ ∑(r₂) (b ↦ f(a)(b)))))   🝖[ _≡_ ]-[]
  f(x₁)(x₂) + (∑(r₁) (a ↦ f(a)(x₂)) + (∑(x₁ ⊰ r₁) (a ↦ ∑(r₂) (b ↦ f(a)(b)))))                     🝖[ _≡_ ]-[ congruence₂-₂(_+_)(f(x₁)(x₂)) (congruence₂-₂(_+_)(∑(r₁) (a ↦ f(a)(x₂))) (∑-swap-nested {f}{x₁ ⊰ r₁}{r₂})) ]
...
∑-of-𝐒 {prepend x r}{f} =
  ∑(x ⊰ r) (𝐒 ∘ f)                 🝖[ _≡_ ]-[]
  𝐒(f(x)) + ∑(r) (𝐒 ∘ f)           🝖[ _≡_ ]-[]
  𝐒(f(x) + ∑(r) (𝐒 ∘ f))           🝖[ _≡_ ]-[ congruence₁(𝐒) (congruence₂-₂(_+_)(f(x)) (∑-of-𝐒 {r}{f})) ]
...
∑-of-[+] {r}{𝐒(n)}{f} =
  ...
  ∑(r) ((_+ n) ∘ f) + length(r)            🝖[ _≡_ ]-[ congruence₂-₁(_+_)(length(r)) (∑-of-[+] {r}{n}{f}) ]
  ((∑(r) f) + (length(r) ⋅ n)) + length(r) 🝖[ _≡_ ]-[ associativity(_+_) {∑(r) f}{length(r) ⋅ n}{length(r)} ]
  (∑(r) f) + ((length(r) ⋅ n) + length(r)) 🝖[ _≡_ ]-[ congruence₂-₂(_+_)(∑(r) f) (commutativity(_+_) {length(r) ⋅ n}{length(r)}) ]
...
∑-even-sum {𝐒 n} =
  ...
  (2 ⋅ length(𝟎 ‥₌ n)) + (n ⋅ 𝐒(n))              🝖[ _≡_ ]-[ congruence₂-₁(_+_)(n ⋅ 𝐒(n)) (congruence₂-₂(_⋅_)(2) (Range-length-zero {𝐒(n)})) ]
...
{-  (a + b) ^ 𝐒(n)                                                                                                            🝖[ _≡_ ]-[]
  (a + b) ⋅ ((a + b) ^ n)                                                                                                   🝖[ _≡_ ]-[ congruence₂-₂(_⋅_)(a + b) (binomial-power{n}{a}{b}) ]
