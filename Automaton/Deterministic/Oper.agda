...
private variable ℓ ℓ₁ ℓ₂ ℓₑ ℓₑ₁ ℓₑ₂ ℓₚ ℓₚ₁ ℓₚ₂ : Lvl.Level
...
module _ ⦃ equiv₁ : Equiv{ℓₑ}(Q₁) ⦄ ⦃ equiv₂ : Equiv{ℓₑ}(Q₂) ⦄ where
  ...
  _⨯_ : Deterministic{ℓₚ₁}(Q₁)(Σ) → Deterministic{ℓₚ₂}(Q₂)(Σ) → Deterministic(Q₁ ⨯' Q₂)(Σ)
  _⨯_ {Σ = Σ} (deterministic δ₁ q₀₁ F₁) (deterministic δ₂ q₀₂ F₂) = deterministic δ q₀ F where
    δ : (Q₁ ⨯' Q₂) → Σ → (Q₁ ⨯' Q₂)
...
module _ ⦃ equiv : Equiv{ℓₑ}(Q) ⦄ where
  ...
  ∁_ : Deterministic{ℓₚ}(Q)(Σ) → Deterministic(Q)(Σ)
