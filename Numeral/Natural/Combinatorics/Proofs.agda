...
𝑐𝑃-step-diff {𝐒 n} {𝐒 k} =
  ...
  where
    ...
    proof1 =
      (𝑐𝑃 n k ⋅ n) ⋅ (𝐒 n)                          🝖[ _≡_ ]-[ congruence₂-₁(_⋅_)(𝐒 n) (𝑐𝑃-step-diff {n}{k}) ]
...
𝑐𝐶-permutations-is-𝑐𝑃 {𝐒 n} {𝐒 k} =
  ...
  where
    l =
      𝑐𝐶 n k ⋅ (𝐒 k ⋅ (k !)) 🝖-[ congruence₂-₂(_⋅_)(𝑐𝐶 n k) (commutativity(_⋅_) {𝐒 k}{k !}) ]
      𝑐𝐶 n k ⋅ ((k !) ⋅ 𝐒 k) 🝖-[ associativity(_⋅_) {x = 𝑐𝐶 n k}{y = k !}{z = 𝐒 k} ]-sym
      (𝑐𝐶 n k ⋅ (k !)) ⋅ 𝐒 k 🝖-[ congruence₂-₁(_⋅_)(𝐒 k) (𝑐𝐶-permutations-is-𝑐𝑃 {n} {k}) ]
      𝑐𝑃 n k ⋅ 𝐒 k           🝖-end
...
𝑐𝑃-full {n} =
  ...
  𝑐𝐶 n n ⋅ (n !) 🝖[ _≡_ ]-[ congruence₂-₁(_⋅_)(n !) (𝑐𝐶-full-subsets {n}) ]
  𝐒(𝟎) ⋅ (n !)   🝖[ _≡_ ]-[]
  n !            🝖-end
...
𝑐𝑃-transfer-factor n@{𝐒 N} {𝐒 k₁} {k₂} eq =
  ...
  ((𝑐𝑃 n k₁) ⋅ 𝐒(k₂)) ⋅ 𝐒(n) 🝖[ _≡_ ]-[ congruence₂-₁(_⋅_)(𝐒(n)) (𝑐𝑃-transfer-factor {N}{k₁}{k₂} (injective(𝐒) eq)) ]
  (𝑐𝑃 n (𝐒(k₁))) ⋅ 𝐒(n)      🝖-end
...
𝑐𝐶-transfer-factor {n}{k₁}{k₂} eq = [⋅]-cancellationᵣ{k₁ !} ⦃ factorial-positive{k₁} ⦄ $
  ...
  (𝑐𝐶(𝐒 n) k₁ ⋅ (k₁ !)) ⋅ 𝐒(k₂) 🝖[ _≡_ ]-[ congruence₂-₁(_⋅_)(𝐒(k₂)) (𝑐𝐶-permutations-is-𝑐𝑃 {𝐒 n}{k₁}) ]
  (𝑐𝑃(𝐒 n) k₁) ⋅ 𝐒(k₂)          🝖[ _≡_ ]-[ 𝑐𝑃-transfer-factor{_}{k₁}{k₂} eq ]
  (𝑐𝑃 n k₁) ⋅ 𝐒(n)              🝖[ _≡_ ]-[ congruence₂-₁(_⋅_)(𝐒(n)) (𝑐𝐶-permutations-is-𝑐𝑃 {n}{k₁}) ]-sym
...
𝑐𝑃-factorial-missing-factors {𝐒 n} {k₁} {𝐒 k₂} eq =
  ...
  (𝑐𝑃 (𝐒(n)) k₁ ⋅ 𝐒(k₂)) ⋅ (k₂ !) 🝖[ _≡_ ]-[ congruence₂-₁(_⋅_)(k₂ !) (𝑐𝑃-transfer-factor {n}{k₁}{k₂} (injective(𝐒) eq)) ]
  (𝑐𝑃 n k₁ ⋅ 𝐒(n)) ⋅ (k₂ !)       🝖[ _≡_ ]-[ congruence₂-₁(_⋅_)(k₂ !) (commutativity(_⋅_) {𝑐𝑃 n k₁}{𝐒(n)}) ]
  (𝐒(n) ⋅ (𝑐𝑃 n k₁)) ⋅ (k₂ !)     🝖[ _≡_ ]-[ associativity(_⋅_) {𝐒(n)}{𝑐𝑃 n k₁}{k₂ !} ]
  𝐒(n) ⋅ ((𝑐𝑃 n k₁) ⋅ (k₂ !))     🝖[ _≡_ ]-[ congruence₂-₂(_⋅_)(𝐒(n)) (𝑐𝑃-factorial-missing-factors{n}{k₁}{k₂} (injective(𝐒) eq)) ]
  𝐒(n) ⋅ (n !)                    🝖[ _≡_ ]-[]
  (𝐒(n)!)                         🝖-end
...
factorial-of-[+] {k₁}{k₂} =
  ...
  𝑐𝑃(k₁ + k₂) k₁ ⋅ (k₂ !)             🝖[ _≡_ ]-[ congruence₂-₁(_⋅_)(k₂ !) (𝑐𝐶-permutations-is-𝑐𝑃 {k₁ + k₂}{k₁}) ]-sym
