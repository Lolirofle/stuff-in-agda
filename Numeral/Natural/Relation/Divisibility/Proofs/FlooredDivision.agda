...
dividesₗ-div {a@(𝐒 _)}{b}   ⦃ pos-b ⦄ ba = [∧]-elimₗ (divides-of-[⋅]ₗ {a ⌊/⌋ b}{b}{a} ([↔]-intro (const([↔]-to-[→] ([⌊/⌋]-positive {a}{b}) (divides-upper-limit ba))) (const pos-b)) (substitute₂ₗ(_∣_) (symmetry(_≡_) ([⋅][⌊/⌋]-inverseOperatorᵣ ba)) (reflexivity(_∣_) {a})))
