...
instance
  ...
  Distributivityᵣ.proof([⋅][−₀]-distributivityᵣ) {x}{y}{z} = p{x}{y}{z} where
    ...
    ... | [∨]-introₗ gt =
      (x −₀ y) ⋅ 𝐒(z)                 🝖[ _≡_ ]-[]
      (x −₀ y) + ((x −₀ y) ⋅ z)       🝖[ _≡_ ]-[ congruence₂-₂(_+_)(x −₀ y) (p {x}{y}{z}) ]
      (x −₀ y) + ((x ⋅ z) −₀ (y ⋅ z)) 🝖[ _≡_ ]-[ [+][−₀]-almost-associativity {x −₀ y} ([≤]-with-[⋅]ᵣ {c = z} gt) ]-sym
      ((x −₀ y) + (x ⋅ z)) −₀ (y ⋅ z) 🝖[ _≡_ ]-[ congruence₂-₁(_−₀_)(y ⋅ z) (commutativity(_+_) {x −₀ y}{x ⋅ z}) ]
      ((x ⋅ z) + (x −₀ y)) −₀ (y ⋅ z) 🝖[ _≡_ ]-[ congruence₂-₁(_−₀_)(y ⋅ z) ([+][−₀]-almost-associativity {x ⋅ z} gt) ]-sym
      (((x ⋅ z) + x) −₀ y) −₀ (y ⋅ z) 🝖[ _≡_ ]-[ congruence₂-₁(_−₀_)(y ⋅ z) (congruence₂-₁(_−₀_)(y) (commutativity(_+_) {x ⋅ z}{x})) ]
      ((x + (x ⋅ z)) −₀ y) −₀ (y ⋅ z) 🝖[ _≡_ ]-[ [−₀][−₀]-to-[−₀][+] {x + (x ⋅ z)}{y}{y ⋅ z} ]
      (x + (x ⋅ z)) −₀ (y + (y ⋅ z))  🝖[ _≡_ ]-[]
      (x ⋅ 𝐒(z)) −₀ (y ⋅ 𝐒(z))        🝖-end
    ... | [∨]-introᵣ lt =
      (x −₀ y) ⋅ 𝐒(z)                🝖[ _≡_ ]-[ congruence₂-₁(_⋅_)(𝐒(z)) ([↔]-to-[→] [−₀]-when-0 (sub₂(_<_)(_≤_) lt)) ]
