...
private variable ℓ ℓ₁ ℓ₂ ℓ₃ ℓ₄ ℓₑ ℓₑ₁ ℓₑ₂ ℓₑ₃ ℓₑ₄ : Lvl.Level
...
module _ ⦃ _ : Equiv{ℓₑ₂}(B) ⦄ ⦃ _ : Equiv{ℓₑ₃}(C) ⦄ {f : B → C}{g : A → B} where
...
module _  ⦃ _ : Equiv{ℓₑ₁}(A) ⦄ ⦃ _ : Equiv{ℓₑ₂}(B) ⦄ {f : B → A}{g : C → B} where
...
module _  ⦃ _ : Equiv{ℓₑ₁}(A) ⦄ ⦃ _ : Equiv{ℓₑ₂}(B) ⦄ where
...
module _  ⦃ _ : Equiv{ℓₑ₁}(A) ⦄ ⦃ _ : Equiv{ℓₑ₂}(B) ⦄ {f₁ f₂ : B → A} {g₁ g₂ : C → B} where
...
module _  ⦃ _ : Equiv{ℓₑ₃}(C) ⦄ {f₁ f₂ : A → C} {g₁ g₂ : B → C} where
...
module _  ⦃ _ : Equiv{ℓₑ₁}(A) ⦄ ⦃ _ : Equiv{ℓₑ₂}(B) ⦄ ⦃ _ : Equiv{ℓₑ₃}(C) ⦄ {f₁ f₂ : A → C} ⦃ _ : Function(f₁) ⦄ {g₁ g₂ : B → C} ⦃ _ : Function(g₁) ⦄  {x₁ x₂ : (A ‖ B)} where
