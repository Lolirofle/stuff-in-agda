...
module _ ⦃ equiv : Equiv{ℓₑ}(U) ⦄ ⦃ singleton : IsUnit(U) ⦄ (_+_ _⋅_ : U → U → U) (−_ : U → U) where
  ...
  Distributivityₗ.proof (PreRg.[⋅][+]-distributivityₗ (Ring.preRg trivialRing)) = uniqueness(U)
  Distributivityᵣ.proof (PreRg.[⋅][+]-distributivityᵣ (Ring.preRg trivialRing)) = uniqueness(U)
