...
module _
  ...
  module _ ⦃ vectorSpace : VectorSpace(_+ᵥ_)(_⋅ₛᵥ_)(_+ₛ_)(_⋅ₛ_) {ℓₙ₀} ⦄ where
    ...
    [⋅ₛᵥ]-absorberₗ {v} = cancellationᵣ(_+ᵥ_) ⦃ One.cancellationᵣ-by-associativity-inverse ⦄ $
      ...
      (𝟎ₛ +ₛ 𝟎ₛ) ⋅ₛᵥ v         🝖-[ congruence₂-₁(_⋅ₛᵥ_)(v) (identityₗ(_+ₛ_)(𝟎ₛ)) ]
    ...
    [⋅ₛᵥ]-absorberᵣ {s} = cancellationᵣ(_+ᵥ_) ⦃ One.cancellationᵣ-by-associativity-inverse ⦄ $
      ...
      s ⋅ₛᵥ (𝟎ᵥ +ᵥ 𝟎ᵥ)         🝖-[ congruence₂-₂(_⋅ₛᵥ_)(s) (identityₗ(_+ᵥ_)(𝟎ᵥ)) ]
    ...
    [⋅ₛᵥ]-negation {v} = _⊜_.proof (One.unique-inverseFunctionᵣ-by-id (intro p) [+ᵥ]-inverseᵣ) {v} where
      ...
      p{v} =
        v +ᵥ ((−ₛ 𝟏ₛ) ⋅ₛᵥ v)          🝖-[ congruence₂-₁(_+ᵥ_) _ (identityₗ(_⋅ₛᵥ_)(𝟏ₛ)) ]-sym
        (𝟏ₛ ⋅ₛᵥ v) +ᵥ ((−ₛ 𝟏ₛ) ⋅ₛᵥ v) 🝖-[ preserving₂(_⋅ₛᵥ v)(_+ₛ_)(_+ᵥ_) ]-sym
        (𝟏ₛ +ₛ (−ₛ 𝟏ₛ))⋅ₛᵥ v          🝖-[ congruence₂-₁(_⋅ₛᵥ_) v (inverseFunctionᵣ(_+ₛ_) ⦃ [∃]-intro _ ⦃ [+ₛ]-identityᵣ ⦄ ⦄ (−ₛ_)) ]
